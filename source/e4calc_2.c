/* e4calc_2.c (c)Copyright Sequiter Software Inc., 1988-1998.  All rights reserved. */
...
int S4FUNCTION expr4calcRemove( EXPR4CALC *calc, int removeAll )
{
   ...
   memcpy( &saveCalcList, &c4base->calcList, sizeof(saveCalcList) ) ;
   memcpy( &tempCalcList, &c4base->calcList, sizeof(saveCalcList) ) ;
   memset( &c4base->calcList, 0, sizeof(c4base->calcList) ) ;
...
int S4FUNCTION expr4calcModify( EXPR4CALC *calc, char *exprSource )
{
   ...
   memcpy( &saveCalcList, &codeBase->calcList, sizeof(saveCalcList) ) ;
   memcpy( &tempCalcList, &codeBase->calcList, sizeof(saveCalcList) ) ;
