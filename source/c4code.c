...
#include "zlib.h"
   ...
   #ifdef __TURBOC__
      #pragma hdrstop
      #if !defined(__DLL__) && !defined(S4OS2PM) && !defined(__WIN32) && !defined(S4WINDOWS)
...
#if defined( __DLL__ ) && defined( S4PASCAL ) && !defined( __WIN32 )
...
#if defined( __DLL__ ) && defined( __WIN32 ) && !defined( S4JOINT_OLEDB_DLL )
...
#if defined( __DLL__ ) && !defined( __WIN32 ) && !defined( S4PASCAL_DOS ) && defined( S4WINDOWS )
   #ifdef P4ARGS_USED
      #pragma argsused
   #endif
...
#if defined( __DLL__ ) && !defined( __WIN32 )
   #ifdef P4ARGS_USED
      #pragma argsused
   #endif
...
int S4FUNCTION code4initLow( CODE4 *c4, const char *defaultProtocol, long versionId, LONGLONG structSize, char skipCom )
{
   ...
   #if !defined( __WIN32 ) && !defined( S4WINDOWS )
...
// for the 2nd u4switch
   ...
   #define S4OPERATING 0x0020  // S4WIN16
      ...
      #error Choose only one of CodeBase switches S4DOS, S4WIN16, __WIN32, S4OS2, __unix__, S4MACINTOSH or S4PASCAL_WIN
   #endif
   #define S4OPERATING 0x0040  // __WIN32
#endif
   ...
   #define S4OPERATING 0x0100  // S4OS2
      ...
      #error Choose only one of CodeBase switches S4DOS, S4WIN16, __WIN32, S4OS2, __unix__, S4MACINTOSH or S4PASCAL_WIN
   #endif
   #define S4OPERATING 0x0200  // __unix__
#endif
...
#ifdef S4PALM
   #ifdef S4OPERATING
      #error Choose only one of CodeBase switches S4DOS, S4WIN16, __WIN32, S4OS2, __unix__, S4MACINTOSH or S4PALM
   #endif
