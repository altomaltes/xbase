...
{
   C4ADDRESS address ;
   int rc, temp= sizeof(struct sockaddr_in) ;
...
int address4makeName(C4ADDRESS *address, short *addrLen, unsigned short portNo, const char *machineName)
{
   ...
   #ifdef E4PARM_LOW
      if (machineName == NULL )
         return error4( NULL, e4parmNull, E96901 ) ;
   #endif
...
int address4makeNetID(C4ADDRESS *address, short *addrLen, C4NETID netID, unsigned short portNo )
{
   #ifdef E4PARM_LOW
      if (address == NULL )
         return error4( NULL, e4parmNull, E96902 ) ;
   #endif
...
*/
   ...
   #ifdef E4PARM_LOW
      if ( (listen==NULL) || (acc==NULL ) )
         return error4( NULL, e4parmNull, E96903 ) ;
   #endif

   acc->sockr = accept(listen->sockr,  NULL, NULL ) ;
   #ifdef S4WINSOCK
...
*/
   ...
   #ifdef E4PARM_LOW
      if ( (listen==NULL) || (acc==NULL ) )
         return error4( NULL, e4parmNull, E96904 ) ;
   #endif
   ...
   while (!acc->sockr)
   {
      ...
      status = select((int)listen->sockr+1, &readfd, (fd_set *)NULL, &errorfd, &timest ) ;
...
*/
   ...
   #ifdef E4PARM_LOW
      if (connect == NULL )
         return error4( NULL, e4parmNull, E96905 ) ;
   #endif
...
*/
   ...
   #ifdef E4PARM_LOW
      if (con == NULL )
         return error4( NULL, e4parmNull, E96907 ) ;
   #endif
...
*/
   ...
   int rc, size, yesFlag = 1;

   #ifdef E4PARM_LOW
      if (hear == NULL)
         return error4( NULL, e4parmNull, E96908 ) ;
   #endif
...
int connect4lowRead(CONNECT4LOW *conlow, char *buffer, int len )
{
   ...
   #ifdef E4PARM_LOW
      if ((connect == NULL) || (buffer == NULL ) || ( len <= 0 ) )
         return error4( NULL, e4parmNull, E96909 ) ;
   #endif
   ...
   do
   {
      ...
      dummy = select((int)conlow->sockr+1, &readfd, (fd_set *)NULL, &errorfd, NULL ) ;
...
int connect4lowWrite(CONNECT4LOW *conlow, char *buffer, int len )
{
   ...
   #ifdef E4PARM_LOW
      if ((connect == NULL) || (buffer == NULL ) || ( len <= 0 ) )
         return error4( NULL, e4parmNull, E96910 ) ;
   #endif
   while(left > 0 )
   {
      ...
      if (nWritten == -1 )
      {
         ...
         #endif
         {
            ...
            dummy = select((int)conlow->sockw+1, (fd_set *)NULL, &writefd, &errorfd, NULL ) ;
...
*/
   ...
   #ifdef E4PARM_LOW
      if ((connect == NULL) || (message == NULL ) || ( event == NULL ) )
         return error4( NULL, e4parmNull, E96911 ) ;
   #endif
...
*/
   ...
   #ifdef E4PARM_LOW
      if ((connect == NULL) || (message == NULL ) || ( event == NULL ) )
         return error4( NULL, e4parmNull, E96912 ) ;
   #endif
...
*/
   ...
   #ifdef E4PARM_LOW
      if ((connect == NULL) || (message == NULL ) )
         return error4( NULL, e4parmNull, E96913 ) ;
   #endif
   ...
   do
   {
      ...
      dummy = select((int)connect->sockw+1, (fd_set *)NULL, &writefd, &errorfd, NULL ) ;
