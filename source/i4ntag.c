...
int tfile4flush( TAG4FILE *t4 )
{
   ...
   #ifdef E4PARM_LOW
      if ( t4 == 0 )
         return error4( 0, e4parmNull, E94901 ) ;
   #endif
...
long S4FUNCTION tfile4recNo( TAG4FILE *t4 )
{
   ...
   #ifdef E4PARM_LOW
      if ( t4 == 0 )
         return (long)error4( 0, e4parmNull, E91642 ) ;
   #endif
...
int tfile4close( TAG4FILE *t4, DATA4FILE *d4 )
{
   ...
   #ifdef E4PARM_LOW
      if ( t4 == 0 )
         return error4( 0, e4parmNull, E91638 ) ;
   #endif
...
int S4FUNCTION t4close( TAG4 *t4 )
{
   ...
   #ifdef E4PARM_HIGH
      if ( t4 == 0 )
         return error4( 0, e4parmNull, E91637 ) ;
   #endif
...
int tfile4doVersionCheck( TAG4FILE *t4, int doSeek, int updateVersion )
{
      ...
      #ifdef E4PARM_LOW
         if ( t4 == 0 )
            return error4( 0, e4parmNull, E91635 ) ;
      #endif
