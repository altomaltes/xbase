/* r4report.c   (c)Copyright Sequiter Software Inc., 1988-1998.  All rights reserved. */
#include "d4all.h"
#ifndef S4OFF_REPORT
#ifdef S4WINDOWS
   #include <commdlg.h>
...
int report4register_classes( PREPORT4 report )
{
   ...
   #ifdef __WIN32
// JACS   reginst = (HINSTANCE)GetWindowLong( report->hWnd, GWL_HINSTANCE );
   reginst = (HINSTANCE)GetWindowLongPtr( 0, GWLP_HINSTANCE );
   ...
   wc.hCursor        = LoadCursor((HWND)NULL,IDC_WAIT);
