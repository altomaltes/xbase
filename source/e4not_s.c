...
#include "d4all.h"
...
#ifdef S4OFF_WRITE
   #ifndef ON_CLIPPER_OFF_WRITE_INDEX
      #define ON_CLIPPER_OFF_WRITE_INDEX
   #endif
   ...
   #endif
   #ifndef S4OFF_CLIPPER_INDEX_WRITE
      #define S4OFF_CLIPPER_INDEX_WRITE
   #endif
      ...
      #define ON_CLIPPER_OFF_WRITE_INDEX
   #endif
   #ifndef S4OFF_CLIPPER_INDEX
      #define S4OFF_CLIPPER_INDEX
   #endif
   #ifndef S4OFF_INDEX_WRITE_ON_MDX_FOX
      #define S4OFF_INDEX_WRITE_ON_MDX_FOX
   #endif
   ...
   // for index-independence of OLE-DB dll, need to export some functions...
      ...
      {
         return error4( tag->index->codeBase, e4notSupported, E91642 ) ;
      }
   ...
   // AS Sept 10/02 - Also include with S4CONSOLE defined to allow building of S4CONSOLE dll
      ...
      #endif
      /* S4CONSOLE or S4OFF_REPORT */
      /* LY July 7/03 : updated from LPSTR S4FUNCTION bmp4FindDIBBits( LPSTR lpbi ) */
      ...
      #endif
      /* S4CONSOLE or S4OFF_REPORT */
      /* LY July 7/03 : changed from FAR* to S4PTR * */
      ...
      short S4FUNCTION d4packWithProgress( DATA4 S4PTR *d4, REINDEX_CALLBACK callback, long milliseconds )
      {
         ...
         return error4( d4->codeBase, e4notWrite, E93004 ) ;
      }
   ...
   // AS Feb 10/03 - Added missing functions
   #ifdef S4OFF_WRITE_INDEX
      int S4FUNCTION i4tagRemove( TAG4 *tag )
      {
         return error4( tag->index->codeBase, e4notSupported, E96702 ) ;
      }
   #endif
   ...
   void S4FUNCTION c4setAcceptTimeOut( CODE4 *c4, long val )
   {
      ...
      error4( 0, e4notSupported, E91007 ) ;
   }
#endif

#ifdef S4LUPACH  /* LY 2004/02/03 */
   DATA4 * S4FUNCTION d4compress( DATA4 S4PTR *data, const char S4PTR *compressedName, short blockSize )
   {
      error4( 0, e4notSupported, E96701 ) ;
      return 0 ;
   }
#endif

// AS Apr 24/06 - clipper s/a support
#if !defined( S4ENCRYPT_DLL )
   int S4FUNCTION code4encryptConnection( CODE4 *c4, int level, int numBits )
   {
      return error4( 0, e4notSupported, E96702 ) ;
   }
#endif
...
#ifdef ON_CLIPPER_OFF_WRITE_INDEX
   #undef ON_CLIPPER_OFF_WRITE_INDEX
#endif
...
#ifdef S4OFF_CLIPPER_INDEX
   #undef S4OFF_CLIPPER_INDEX
#endif

#ifdef S4OFF_CLIPPER_INDEX_WRITE
   #undef S4OFF_CLIPPER_INDEX_WRITE
#endif
